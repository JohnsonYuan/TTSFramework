//----------------------------------------------------------------------------
// <copyright file="XmlUnitFeatureFile.cs" company="Microsoft">
//     Copyright (c) Microsoft Corporation.  All rights reserved.
// </copyright>
//
// <summary>
//     This module implements class XmlUnitFeatureFile
// </summary>
//----------------------------------------------------------------------------
...
namespace Microsoft.Tts.Offline
{
    ...
    public class UnitFeature
    {
        ...
        private TtsBreak _break;
        private WordType _wordType;
        private int _domain = (int)ScriptDomain.Normal;
        private TtsUnitFeature _linguisticFeature;
        private TtsAcousticFeature _acousticFeature;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnitFeature"/> class.
        /// </summary>
        public UnitFeature()
        {
        }
        ...
        public UnitFeature(string sentenceId, int index)
        {
        ...
        public string Id
        {
            get
            {
                Debug.Assert(!string.IsNullOrEmpty(SentenceId));
            ...
            set
            {
                if (value < 0)
                {
                    string message = string.Format(CultureInfo.InvariantCulture,
                        "Unit index is {0}, it should not be negative", value);
        ...
        /// </summary>
        public TtsUnitFeature LingusitcFeature
        {
            get
            {
                return _linguisticFeature;
            }
        ...
        public TtsBreak Break
        {
            ...
            set
            {
                Helper.ValidateEnumValue(typeof(TtsBreak), (int)value);
                _break = value;
            }
        }
        ...
        public WordType WordType
        {
            ...
            set
            {
                Helper.ValidateEnumValue(typeof(WordType), (int)value);
                _wordType = value;
            }
        }
        ...
        /// </summary>
        public TtsAcousticFeature AcousticFeature
        {
            get
            {
        ...
        public void ToXml(XmlWriter writer)
        {
            ...
            writer.WriteAttributeString("sId", _sentenceId);
            writer.WriteAttributeString("index", _index.ToString(CultureInfo.InvariantCulture));
            writer.WriteAttributeString("name", _name);
            if (_domain != (int)ScriptDomain.Normal)
            {
                writer.WriteAttributeString("domain", _domain.ToString(CultureInfo.InvariantCulture));
            }

            // Write Linguistic Features
            if (_linguisticFeature != null)
            {
                writer.WriteStartElement("lingF");
                writer.WriteAttributeString("pInS",
                    ((int)_linguisticFeature.PosInSentence).ToString(CultureInfo.InvariantCulture));
                writer.WriteAttributeString("pInW",
                    ((int)_linguisticFeature.PosInWord).ToString(CultureInfo.InvariantCulture));
                writer.WriteAttributeString("pInSyl",
                    ((int)_linguisticFeature.PosInSyllable).ToString(CultureInfo.InvariantCulture));
                writer.WriteAttributeString("lPh",
                    _linguisticFeature.LeftContextPhone.ToString(CultureInfo.InvariantCulture));
                writer.WriteAttributeString("rPh",
                    _linguisticFeature.RightContextPhone.ToString(CultureInfo.InvariantCulture));
                writer.WriteAttributeString("lTone",
                    _linguisticFeature.LeftContextTone.ToString(CultureInfo.InvariantCulture));
                writer.WriteAttributeString("rTone",
                    _linguisticFeature.RightContextTone.ToString(CultureInfo.InvariantCulture));
                writer.WriteAttributeString("emph",
                    ((int)_linguisticFeature.TtsEmphasis).ToString(CultureInfo.InvariantCulture));
                writer.WriteAttributeString("stress",
                    ((int)_linguisticFeature.TtsStress).ToString(CultureInfo.InvariantCulture));
                writer.WriteAttributeString("wTone",
                    ((int)_linguisticFeature.TtsWordTone).ToString(CultureInfo.InvariantCulture));
                writer.WriteAttributeString("break",
                    ((int)_break).ToString(CultureInfo.InvariantCulture));
                writer.WriteAttributeString("wType",
                    ((int)_wordType).ToString(CultureInfo.InvariantCulture));
                writer.WriteEndElement();
            }

            // Write Acoustic Features
            if (_acousticFeature != null)
            {
                writer.WriteStartElement("acousF");

                string startTimeText = string.Format(CultureInfo.InvariantCulture,
                    "{0,9:0.000000}", _acousticFeature.StartTime);
                writer.WriteAttributeString("tOffset", startTimeText.Trim());
                string durationText = string.Format(CultureInfo.InvariantCulture,
                    "{0,9:0.000000}", _acousticFeature.Duration);
                writer.WriteAttributeString("tLen", durationText.Trim());

                string sampleOffsetText =
                    _acousticFeature.SampleOffset.ToString(CultureInfo.InvariantCulture);
                writer.WriteAttributeString("sOffset", sampleOffsetText.Trim());
                string sampleLengthText =
                    _acousticFeature.SampleLength.ToString(CultureInfo.InvariantCulture);
                writer.WriteAttributeString("sLen", sampleLengthText.Trim());

                string epochOffsetText =
                    _acousticFeature.EpochOffset.ToString(CultureInfo.InvariantCulture);
                writer.WriteAttributeString("eOffset", epochOffsetText.Trim());
                string epochLengthText =
                    _acousticFeature.EpochLength.ToString(CultureInfo.InvariantCulture);
                writer.WriteAttributeString("eLen", epochLengthText.Trim());

                string rmsCartText = string.Format(CultureInfo.InvariantCulture,
                    "{0,7:0.0}", _acousticFeature.CartRms);
                writer.WriteAttributeString("rmsCart", rmsCartText.Trim());
                string rmsEText = string.Format(CultureInfo.InvariantCulture,
                    "{0,7:0.0}", _acousticFeature.EnergyRms);
                writer.WriteAttributeString("rmsE", rmsEText.Trim());

                string energyText = string.Format(CultureInfo.InvariantCulture,
                    "{0,8:0.00}", _acousticFeature.Energy);
                writer.WriteAttributeString("energy", energyText.Trim());

                string averagePitchText = string.Format(CultureInfo.InvariantCulture,
                    "{0,7:0.0}", _acousticFeature.AveragePitch);
                writer.WriteAttributeString("pAvg", averagePitchText.Trim());
                string pitchRangeText = string.Format(CultureInfo.InvariantCulture,
                    "{0,7:0.0}", _acousticFeature.PitchRange);
                writer.WriteAttributeString("pRange", pitchRangeText.Trim());

                string epoch16KCompressedLengthText =
                    _acousticFeature.Epoch16KCompressLength.ToString(CultureInfo.InvariantCulture);
                writer.WriteAttributeString("ecLen16k", epoch16KCompressedLengthText.Trim());
                string epoch8KCompressedLengthText =
                    _acousticFeature.Epoch8KCompressLength.ToString(CultureInfo.InvariantCulture);
                writer.WriteAttributeString("ecLen8k", epoch8KCompressedLengthText.Trim());

                string sample8KLengthText =
                    _acousticFeature.Sample8KLength.ToString(CultureInfo.InvariantCulture);
                writer.WriteAttributeString("sLen8k", sample8KLengthText.Trim());

                string averageEpochText = string.Format(CultureInfo.InvariantCulture,
                    "{0, 10:0.0000}", _acousticFeature.AverageEpoch);
                writer.WriteAttributeString("eAvg", averageEpochText.Trim());
                string normalizedEpochText = string.Format(CultureInfo.InvariantCulture,
                    "{0, 10:0.0000}", _acousticFeature.NormalizedEpoch);
                writer.WriteAttributeString("eNormAvg", normalizedEpochText.Trim());
    ...
    /// Unit feature file.
    /// </summary>
    public class XmlUnitFeatureFile
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlUnitFeatureFile"/> class.
        /// </summary>
        public XmlUnitFeatureFile()
        {
        }
        ...
        public XmlUnitFeatureFile(string filePath)
        {
            Load(filePath);
        }
        ...
        public static ErrorSet ExtractFeature(XmlScriptFile script,
            string fileMapFilePath, string segmentDir, string wave16kDir,
            string epochDir, XmlUnitFeatureFile featureFile)
        {
        ...
        {
            ErrorSet errorSet = ExtractLinguistic(script, units);

            ErrorSet subErrors = ExtractAcoustic(script, fileMap, segmentDir,
        ...
        /// <param name="featureFile">Unit feature file.</param>
        /// <returns>Error information set.</returns>
        public static ErrorSet ExtractFeature(string scriptFilePath, Language language,
            string fileMapFilePath, string segmentDir, string wave16kDir,
            string epochDir, XmlUnitFeatureFile featureFile)
        {
            ...
            System.Diagnostics.Debug.Assert(script.ErrorSet.Count == 0);
            ...
            string epochDir, string unitFeatureFilePath)
        {
            ...
            XmlUnitFeatureFile featureFile = new XmlUnitFeatureFile();
            ErrorSet errorSet = ExtractFeature(script, fileMap, segmentDir, wave16kDir,
                epochDir, featureFile);
        ...
        /// <param name="units">Unit feature collection.</param>
        /// <returns>Error information set.</returns>
        public static ErrorSet ExtractLinguistic(XmlScriptFile script,
            SortedDictionary<string, UnitFeature> units)
        {
            ...
            foreach (string sid in script.ItemDic.Keys)
            {
                try
                {
                    ExtractLinguistic(script.ItemDic[sid], units);
                }
                catch (InvalidDataException ide)
                {
                    string message = string.Format(CultureInfo.InvariantCulture,
                        "Failed to extract linguistic afeature for sentence [{0}] of file {1}. {2}",
                        sid, script.FilePath, Helper.BuildExceptionMessage(ide));
        ...
        /// <param name="featureFile">Unit feature file.</param>
        /// <returns>Error information set.</returns>
        public static ErrorSet ExtractLinguistic(XmlScriptFile script, XmlUnitFeatureFile featureFile)
        {
            if (featureFile == null)
            {
                throw new ArgumentNullException("featureFile");
        ...
        /// <returns>Error information set.</returns>
        public static ErrorSet ExtractAcoustic(XmlScriptFile script, FileListMap fileMap,
            ...
            SortedDictionary<string, UnitFeature> units)
        {
            ...
            foreach (string sid in script.ItemDic.Keys)
            {
                try
                {
                    ExtractAcoustic(script.ItemDic[sid], fileMap, segmentDir,
                        wave16kDir, epochDir, units);
                }
                catch (InvalidDataException ide)
                {
                    string message = string.Format(CultureInfo.InvariantCulture,
                        "Failed to extract acoustic feature for sentence [{0}] of file [{1}]. {2}",
                        sid, script.FilePath, Helper.BuildExceptionMessage(ide));
                    errorSet.Add(ScriptError.OtherErrors, sid, message);
                }
            }
        ...
        /// <returns>Error information set.</returns>
        public static ErrorSet ExtractAcoustic(XmlScriptFile script, FileListMap fileMap,
            string segmentDir, string wave16kDir, string epochDir, XmlUnitFeatureFile featureFile)
        {
            if (featureFile == null)
            {
                throw new ArgumentNullException("featureFile");
            ...
            foreach (string key in units.Keys)
            {
                ...
                foreach (ScriptDomain domainType in domainConfig.DomainLists.Keys)
                {
                    ...
                    if (domainList.Contains(unit.SentenceId))
                    {
                        ...
                        if (domainList.SharedWithNormalDomain)
                        {
                            type |= (int)ScriptDomain.Normal;
                        }
                    }
                }
        ...
        public static void BuildWaveUnitInfo(XmlUnitFeatureFile featureFile, string waveUnitInfoFilePath)
        {
            // Validate Parameters
            if (featureFile == null)
            {
        ...
        public static void BuildWaveSegmentSequence(XmlUnitFeatureFile featureFile, string mapFilePath, string waveSegmentSequenceFilePath)
        {
            // Validate Parameters
            if (featureFile == null)
            {
            ...
            Language language, UnitList filteringUnitList)
        {
            ...
            if (units.Keys == null)
            {
                throw new ArgumentException("units.Keys");
            }
        ...
        public static void Merge(XmlUnitFeatureFile sourceFile, XmlUnitFeatureFile targetFile)
        {
            // Validate Parameters
            if (sourceFile == null)
            {
            ...
            SortedDictionary<string, UnitFeature> units)
        {
            ...
            Phoneme phoneme = Localor.GetPhoneme(scriptItem.Language);
            SliceData sliceData = Localor.GetSliceData(scriptItem.Language);
            Collection<TtsUnit> itemUnits = scriptItem.GetUnits(phoneme, sliceData);
            for (int i = 0; i < itemUnits.Count; i++)
            {
                UnitFeature unit = GetUnitFeature(scriptItem.Id, i, itemUnits[i].FullName, units);
                unit.LingusitcFeature = itemUnits[i].Feature;
                unit.Break = itemUnits[i].TtsBreak;
                unit.WordType = itemUnits[i].WordType;
            }
        }
            ...
            string epochDir, SortedDictionary<string, UnitFeature> units)
        {
            ...
            Collection<TtsUnit> itemUnits = scriptItem.GetUnits(phoneme, sliceData);
            Debug.Assert(itemUnits.Count == totalCount);
            if (itemUnits.Count != totalCount)
            {
                ...
                string message = string.Format(CultureInfo.InvariantCulture,
                    str1 + str2 + str3,
                    scriptItem.Id, segFile.FilePath, itemUnits.Count, totalCount);
                throw new InvalidDataException(message);
            }

            for (int i = 0; i < itemUnits.Count; i++)
            {
                UnitFeature unit = GetUnitFeature(sid, i, itemUnits[i].FullName, units);
